...
using AlgoTradeForge.LiveHost.WebApi.Tests.Infrastructure;
using Xunit;

namespace AlgoTradeForge.LiveHost.WebApi.Tests.Endpoints;

public class LiveSessionDataEndpointTests : IClassFixture<LiveHostApiFactory>
{
    private static readonly JsonSerializerOptions JsonOptions = new() { PropertyNameCaseInsensitive = true };
    private readonly HttpClient _client;

    public LiveSessionDataEndpointTests(LiveHostApiFactory factory)
    {
