...
As the starting point create tests verifying the behavior of endpoints described in stills /backtest and /optimize - use data and the model strategy from there.

All endpoints should be covered.