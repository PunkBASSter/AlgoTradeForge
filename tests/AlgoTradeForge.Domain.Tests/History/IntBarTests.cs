...
public class IntBarTests
{
    ...
    public void IntBar_CanHoldValuesExceedingIntMaxValue()
    {
        ...
        var bar = new IntBar(largeValue, largeValue + 100, largeValue - 100, largeValue + 50, largeValue * 10);
    ...
    {
        var bar1 = new IntBar(100, 200, 50, 150, 1000);
        var bar2 = new IntBar(100, 200, 50, 150, 1000);
        var bar3 = new IntBar(100, 200, 50, 151, 1000);
    ...
    {
        var bar = new IntBar(0, 0, 0, 0, long.MaxValue);
    ...
    public void IntBar_BtcPrice_WithDecimalDigits8_FitsInLong()
    {
        ...
        var bar = new IntBar(btcPrice, btcPrice + 1000, btcPrice - 1000, btcPrice, 500_000_000L);
