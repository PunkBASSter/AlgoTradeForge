...
public sealed record ListOptimizationRunsQuery(OptimizationRunQuery Filter) : IQuery<PagedResult<OptimizationRunRecord>>;

public sealed class ListOptimizationRunsQueryHandler(
    IRunRepository repository) : IQueryHandler<ListOptimizationRunsQuery, PagedResult<OptimizationRunRecord>>
{
