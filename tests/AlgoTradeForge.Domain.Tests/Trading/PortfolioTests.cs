...
public class PortfolioTests
{
    ...
    {
        var portfolio = new Portfolio { InitialCash = 100_000m };
    ...
    public void Equity_SinglePrice_CashOnly_ReturnsCash()
    {
        ...
        Assert.Equal(100_000m, portfolio.Equity(150m));
    }
    ...
    public void Equity_SinglePrice_WithEquityPosition_CalculatesCorrectly()
    {
        ...
        // Total: 101000
        Assert.Equal(101_000m, portfolio.Equity(160m));
    }
    ...
    public void Equity_PriceDict_MultiplePositions_CalculatesCorrectly()
    {
        var portfolio = new Portfolio { InitialCash = 100_000m };
        portfolio.Initialize();
        portfolio.Apply(TestFills.BuyAapl(150m, 100m));
        portfolio.Apply(TestFills.Buy(TestAssets.Msft, 300m, 50m));
        ...
        Assert.Equal(102_000m, portfolio.Equity(prices));
    }
    ...
    public void Equity_PriceDict_MissingPrice_ExcludesFromValue()
    {
        ...
        // Total: 86000
        Assert.Equal(86_000m, portfolio.Equity(prices));
    }
    ...
    public void Apply_BuyOrder_DeductsCash()
    {
        ...
        Assert.Equal(85_000m, portfolio.Cash);
    }
    ...
    public void Apply_SellOrder_AddsCash()
    {
        ...
        portfolio.Apply(TestFills.SellAapl(160m, 100m));

        // 85000 + 160*100 = 101000
        Assert.Equal(101_000m, portfolio.Cash);
    }
    ...
    public void Apply_WithCommission_DeductsFromCash()
    {
        ...
        portfolio.Apply(TestFills.BuyAapl(150m, 100m, commission: 5m));

        // 100000 - 150*100 - 5 = 84995
        Assert.Equal(84_995m, portfolio.Cash);
    }
    ...
    {
        var portfolio = new Portfolio { InitialCash = 500_000m };
        portfolio.Initialize();

        portfolio.Apply(TestFills.BuyEs(5000m, 2m));
