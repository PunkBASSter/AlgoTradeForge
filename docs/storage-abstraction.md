...
```json
{
  "Storage": {
    ...
    "S3": {
      "Endpoint": "",          // optional, for S3-compatible providers (MinIO, R2)
      "Region": "us-east-1",
