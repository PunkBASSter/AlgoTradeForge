...
public interface IRunRepository
{
    ...
    Task<IReadOnlyList<BacktestRunRecord>> QueryAsync(BacktestRunQuery query, CancellationToken ct = default);
    ...
    Task<IReadOnlyList<OptimizationRunRecord>> QueryOptimizationsAsync(OptimizationRunQuery query, CancellationToken ct = default);
