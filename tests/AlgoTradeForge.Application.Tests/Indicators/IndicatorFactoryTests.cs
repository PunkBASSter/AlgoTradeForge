...
public class IndicatorFactoryTests
{
    ...
    {
        var inner = new DeltaZigZag(0.5, 10.0);
    ...
    {
        var bus = new CapturingEventBus();
        _ = new EmittingIndicatorDecorator<Int64Bar, long>(new DeltaZigZag(0.5, 10.0), bus, ExportableSub);
    ...
    public void RetroactiveMutation_CarriesChartIds()
    {
        ...
        var dzz = new DeltaZigZag(0.5, 10.0);
    ...
    private sealed class NamedDeltaZigZag(string name, double delta, double minimumThresholdPct) : IIndicator<Int64Bar, long>
    {
